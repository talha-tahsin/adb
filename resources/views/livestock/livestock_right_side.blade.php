      ...
      <h4>(3)	Pest and Diseases of Livestock and Poultry</h4>
        <table width="100%" class="table table-bordered table-striped table-hover tableFixHead" id="diseases_table">
            ...
            <thead>
              <tr style="background-color: #8ed6f2;">
                ...
                <th style="text-align: lrft;">Disease Name</th>
        ...
        <h4>(4)	Farm-house cost of production (if possible)</h4>
        <table width="100%" class="table table-bordered table-striped table-hover tableFixHead" id="farm_house_cost">

            <thead>
              <tr style="background-color: #8ed6f2;">
                <th style="text-align: center;">Serial</th>
                <th style="text-align: left;">Item</th>
                <th style="text-align: left;">Unit Cost (BDT)</th>
                <th style="text-align: left;">Total Cost (BDT)</th>
              </tr>
            </thead>
