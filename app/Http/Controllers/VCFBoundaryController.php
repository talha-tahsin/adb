        ...
        try 
        {
            ...
            foreach ($xmlstr->row as $value) 
            {
                ...
                $store_data = array(
                    ...
                    'para_name' => $value->para_name,
                    'para_id' => $value->para_id,
                    'plot1_location' => $value->plot1_location,
                    'plot1_dimension' => $value->plot1_dimension,
        ...
        try 
        {
            ...
            foreach ($xmlstr->row as $value) 
            {
                ...
                $store_data = array(
                    ...
                    'para_name' => $value->para_name,
                    'para_id' => $value->para_id,
                    'plot2_location' => $value->plot2_location,
                    'plot2_dimension' => $value->plot2_dimension,
        ...
        try 
        {
            ...
            foreach ($xmlstr->row as $value) 
            {
                ...
                $store_data = array(
                    ...
                    'para_name' => $value->para_name,
                    'para_id' => $value->para_id,
                    'plot3_location' => $value->plot3_location,
                    'plot3_dimension' => $value->plot3_dimension,
